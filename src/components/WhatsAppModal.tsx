      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Para: <span className="font-semibold">{clientName}</span> ({phone})
          </p>
        </div>
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: 10:30, 15 minutos, etc."
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
            />
            <p className="text-xs text-gray-500 mt-1">
              Añade una hora específica o tiempo de retraso
            </p>
          </div>
        ...
        <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 rounded-b-2xl flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
